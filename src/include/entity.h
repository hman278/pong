...
#define ENTITY_DEFAULT_FRICTION 0.0f
...
// For simplicity, an entity is assumed to be a 2D rectangle with a texture and optional speed
...
Vector2 entity_get_velocity(Entity* entity);
